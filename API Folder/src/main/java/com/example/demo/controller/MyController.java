...
public class MyController {
    ...
    public ResultPath receiveData(@RequestBody MyRequest request)
    {
        ...
        Node start = new Node("Start", request.getloc1().latitude,request.getloc1().longitude); // Example coordinates
        Node goal = new Node("Goal",   request.getloc2().latitude,request.getloc2().longitude); // Example coordinates
